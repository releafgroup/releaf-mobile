...
describe('ReleafMobile', () => {

  let comp: ReleafMobile;
  let fixture: ComponentFixture<ReleafMobile>;
  let de: DebugElement;
  let el: HTMLElement;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ReleafMobile);
